...
struct AnimatedMeshView: View {
    ...
    var body: some View {
        MeshGradient(width: 3, height: 3, points: [
            .init(0, 0), .init(1.5, 0), .init(1, 2),

            [sinInRange(-2.8...(-0.2), offset: 0.439, timeScale: 0.342, t: t), sinInRange(0.3...0.7, offset: 3.42, timeScale: 0.984, t: t)],
            ...
            .colorA4, .colorA3, .indigo,
            .colorA1, .white, .blue,
            .colorA5, .black, .colorA2
        ])
        .onAppear {
